  ...
  return (
    <section className="-mt-2">
      <div className="flex flex-col md:flex-row lg:flex-row">
        <div className="w-full lg:w-1/2 bg-[#EE3137] flex items-center ">
          {homeData.map((item) => (
            <div className="flex flex-col w-full p-8">
              ...
              <div className="py-4">
                <p className="text-md text-white mb-6">{item.sectionDesc}</p>
              </div>
              <div className="">
                <Button
                  size="lg"
        ...
        <div className="w-full lg:w-1/2 py-[50px]">
          {homeData.map((item) => (
            <div className="w-full md:w-3/4 lg:w-3/4 mx-auto text-center">
              ...
              <Separator className="w-3/4 mx-auto my-2 bg-[#EE3137]" />
